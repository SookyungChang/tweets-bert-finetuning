...
def get_topics(df: pd.DataFrame, sentiment_label: int, min_cluster_size=10):
    ...
    hdbscan_model = hdbscan.HDBSCAN(min_cluster_size=min_cluster_size, metric="euclidean", prediction_data=True)
    ...
    new_topics = topic_model.reduce_outliers(df_sentiment["text"].tolist(), topics, strategy="c-tf-idf")
