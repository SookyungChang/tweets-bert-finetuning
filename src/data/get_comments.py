    ...
    while True:
        ...
        for item in response['items']:
            ...
            comments.append({
                ...
                'publishedAt': comment['publishedAt'] # Timestamp when comment was posted
            })
...
if __name__ == "__main__":
    ...
    comments_df = get_comments(video_id, YoutubeCommentsConfig.MAX_RESULTS, YoutubeCommentsConfig.MAX_PAGES)
